...
TO STUDENT: You may add to this file, but do not change anything that is
    already here!
Modified by: [Jonathan Fan] on [10/12/2023]
Changelog: [Added: #include skills_list.h]
*/
...
struct pirate{
    ...
    char vessel[MAX_LINE+1];
    char rank[MAX_LINE+1];
...
/**
 * Prints the rating for skills_list
 */
